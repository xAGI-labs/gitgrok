...
export function GitLabIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 21.42l3.684-11.333H8.316L12 21.42zM3.16 10.087L12 21.42l-8.84-11.333c-.185-.248-.198-.592-.028-.854L4.947 6.6c.158-.244.428-.395.72-.395.292 0 .562.151.72.395L3.16 10.087zM12 21.42l8.84-11.333c.185-.248.198-.592.028-.854L19.053 6.6c-.158-.244-.428-.395-.72-.395-.292 0-.562.151-.72.395L20.84 10.087z"/>
    </svg>
  );
}

export function ProcessingIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
